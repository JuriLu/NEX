          ...
          <p-card styleClass="shadow-4 border-round-xl">
            ...
            <form [formGroup]="contactForm" (ngSubmit)="onSubmit()" class="flex flex-column gap-4">
              <div class="field">
                ...
                />
                @if ((submitted || contactForm.get('name')?.touched) &&
                contactForm.get('name')?.invalid) {
                <div class="validation-warning mt-2 p-2 border-round">
                  <i class="pi pi-exclamation-circle mr-2"></i>
                  @if (contactForm.get('name')?.hasError('pattern')) { Please use only letters and
                  spaces. } @else { Name is required. }
                </div>
                }
              </div>
              <div class="field">
                ...
                />
                @if ((submitted || contactForm.get('email')?.touched) &&
              ...
              <div class="field">
                ...
                ></textarea>
                @if ((submitted || contactForm.get('message')?.touched) &&
