...
import { selectIsAdmin, selectIsLoggedIn, selectUser } from '../../../core/store/auth/auth.selectors';
...
@Component({
  selector: 'app-navbar',
  standalone: true,
  imports: [CommonModule, RouterLink, RouterLinkActive, ButtonModule, ToolbarModule, AvatarModule, MenuModule],
