...
3.  **👤 User Profiles**: Polishing the personal data and "Driver Identity" sections.
4.  **💡 Interior Lighting Picker**: A fun UI feature allowing users to change the "Ambient Purple" to other cockpit colors (Blue, Gold, Emerald).
